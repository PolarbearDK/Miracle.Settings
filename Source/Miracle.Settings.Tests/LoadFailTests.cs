    ...
    public class LoadFailTests : LoadTestBase
    {
        ...
        public void CreateMissingStringSettingTest()
        {
            AssertThrowsSettingsExceptionMessageTest<MissingStringSetting>(
                ...
                typeof(String), 
                Settings.SettingsLoader.GetSettingKey(NotFoundPrefix, nameof(MissingStringSetting.MissingString)));
        }
        ...
        public void CreateMissingDateTimeSettingTest()
        {
            AssertThrowsSettingsExceptionMessageTest<MissingDateTimeSetting>(
                Resources.MissingValueFormat, 
                typeof(DateTime), 
                Settings.SettingsLoader.GetSettingKey(NotFoundPrefix, nameof(MissingDateTimeSetting.MissingDateTime)));
        }
        ...
        public void CreateMissingUriSettingTest()
        {
            AssertThrowsSettingsExceptionMessageTest<MissingUriSetting>(
                Resources.MissingValueFormat, 
                typeof(Uri), 
                Settings.SettingsLoader.GetSettingKey(NotFoundPrefix, nameof(MissingUriSetting.MissingUri)));
        }
        ...
        public void CreateMissingTimeSpanSettingTest()
        {
            AssertThrowsSettingsExceptionMessageTest<MissingTimeSpanSetting>(
                Resources.MissingValueFormat, 
                typeof(TimeSpan), 
                Settings.SettingsLoader.GetSettingKey(NotFoundPrefix, nameof(MissingTimeSpanSetting.MissingTimeSpan)));
        }
        ...
        public void CreateMissingIntSettingTest()
        {
            AssertThrowsSettingsExceptionMessageTest<MissingIntSetting>(
                Resources.MissingValueFormat, typeof(int), 
                Settings.SettingsLoader.GetSettingKey(NotFoundPrefix, nameof(MissingIntSetting.MissingInt)));
        }
        ...
        public void CreateMissingFileInfoSettingTest()
        {
            AssertThrowsSettingsExceptionMessageTest<MissingFileInfoSetting>(
                Resources.MissingValueFormat, 
                typeof(FileInfo),
                Settings.SettingsLoader.GetSettingKey(NotFoundPrefix, nameof(MissingFileInfoSetting.MissingFile)));
        }
        ...
        public void CreateMissingDirectoryInfoSettingTest()
        {
            AssertThrowsSettingsExceptionMessageTest<MissingDirectoryInfoSetting>(
                ...
                Settings.SettingsLoader.GetSettingKey(NotFoundPrefix, nameof(MissingDirectoryInfoSetting.MissingDir)));
        }
        ...
        public void CreateMissingArraySettingTest()
        {
            AssertThrowsSettingsExceptionMessageTest<ArraySettings>(
                Resources.MissingValueFormat, 
                typeof(string[]), 
                Settings.SettingsLoader.GetSettingKey(NotFoundPrefix, nameof(ArraySettings.MySimpleArrayProperty)));
        }
        ...
        public void CreateMissingListSettingTest()
        {
            AssertThrowsSettingsExceptionMessageTest<ListSettings>(
                Resources.MissingValueFormat, 
                typeof(IList<string>),
                Settings.SettingsLoader.GetSettingKey(NotFoundPrefix, nameof(ListSettings.MySimpleListProperty)));
        }
        ...
        public void CreateMissingDictionarySettingTest()
        {
            AssertThrowsSettingsExceptionMessageTest<DictionarySettings>(
                ...
                Settings.SettingsLoader.GetSettingKey(NotFoundPrefix, nameof(DictionarySettings.MySimpleDictionaryProperty)));
        }
        ...
        public void CreateMissingNestedSettingTest()
        {
            AssertThrowsSettingsExceptionMessageTest<NestedSettings>(
                Resources.MissingValueFormat, 
                typeof(string), 
                Settings.SettingsLoader.GetSettingKey(NotFoundPrefix, nameof(NestedSettings.MyNestedProperty), nameof(Nested.Foo)));
        }
        ...
        public void BadTypeConverterSettingTest()
        {
            AssertThrowsSettingsExceptionMessageTest<BadTypeConverterSetting>(
                ...
                string.Format(Resources.CreateTypeConverterErrorFormat, typeof(string)),
                Settings.SettingsLoader.GetSettingKey(NotFoundPrefix, nameof(BadTypeConverterSetting.Foo)));
        }
        ...
        public void ExplicitTypeConversionFailureSettingTest()
        {
            AssertThrowsSettingsExceptionMessageTest<ExplicitTypeConversionFailureSetting>(
                Resources.ConversionErrorSuffix,
                string.Format(Resources.ExplicitTypeConverterErrorFormat, "http://XYZ", typeof(int)),
                Settings.SettingsLoader.GetSettingKey(NotFoundPrefix, nameof(BadTypeConverterSetting.Foo)));
        }
    }
}
