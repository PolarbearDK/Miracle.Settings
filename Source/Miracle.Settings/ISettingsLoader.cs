...
namespace Miracle.Settings
{
    ...
    {
		/// <summary>
		/// Create an object of type T initialized with settings prefixed by <paramref name="prefix"/>
		/// </summary>
		...
		/// <summary>
		/// Create array of type T from settings prefixed by <paramref name="prefix"/>
		/// </summary>
		...
		/// <summary>
		/// Create list from settings prefixed by <paramref name="prefix"/>
		/// </summary>
		/// <param name="prefix">The prefix of all settings in the array</param>
		...
		/// <summary>
		/// Load settings prefixed by <paramref name="prefix"/> into existing object instance
		/// </summary>
		/// <typeparam name="T"></typeparam>
